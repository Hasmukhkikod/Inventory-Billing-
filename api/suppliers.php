    ...
    case 'bulk':
        ...
        try {
            if ($bulk_action === 'delete') {
                ...
                $db->query("UPDATE suppliers SET status = 'INACTIVE', deleted_at = CURRENT_TIMESTAMP WHERE id IN ($placeholders)", $ids);
                Helpers::logActivity($db, 'suppliers', 'Bulk deleted ' . count($ids) . ' records');
