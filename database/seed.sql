...
INSERT IGNORE INTO company_settings (id, company_name, company_logo, gst_number, phone, email, website, address, city, state, country, pincode, invoice_prefix, currency, timezone, gst_slabs, invoice_footer, invoice_terms, status, state_code, loyalty_enabled, loyalty_points_per_100, loyalty_redeem_value, thermal_width, invoice_template, bank_name, bank_account_no, bank_ifsc, bank_branch, upi_id) VALUES
(1, 'Grovixo', '', '27AAAAA1234A1Z5', '+91 98765 43210', 'info@grovixo.com', 'www.grovixo.com', '404 Premium Business Tower, Senapati Bapat Marg, Lower Parel', 'Mumbai', 'Maharashtra', 'India', '400013', 'INV-', 'INR', 'Asia/Kolkata', '0,5,12,18,28', 'Thank you for your business!', '1. Goods once sold will not be taken back or exchanged.\n2. Subject to Mumbai Jurisdiction.', 'ACTIVE', '27', 0, 1, 1.00, '80mm', 'standard', '', '', '', '', '');
